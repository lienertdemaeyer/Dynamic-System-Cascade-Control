...
\begin{table}[H]
    ...
    \hline
    $K_e [Vs/m]$ & $c [Ns/m]$ & Evaluatiemodel & Ontwerpmodel \\ 
    \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c c c|}
    \hline
    $K_r_c [V/m]$ & Evaluatiemodel & Ontwerpmodel \\
    \hline
    ...
    \hline
    400000 & -71,0859;0,6096+17,3561i;0,6096-17,3561i & -1,6000+17,8616i;-1,6000-17,861i \\
    \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c c c c|}
    \hline
    $K_r_c [V/m]$ & $\tau [s]$  & Evaluatiemodel & Ontwerpmodel \\
    \hline
